...
<body>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-black">
        <a class="navbar-brand" href="./"><img src="https://i.pinimg.com/originals/15/e0/c7/15e0c7e0317886fb215e2b7bd7b33eee.png" alt="logo" width="70px">Blog Website</a>
    ...
    <div class="jumbotron">
      <div class="container">
        <div id="details" class="animated fadeInLeft">
          <h1 style=" color:#fff !important;">Personal <span style="color:green !important;">Blog</span></h1>
          <p style=" color:#fff !important;">Develop your skills online.</p>
        </div>
      </div>
      <img src="http://www.inter-vision.ca/wp-content/uploads/2016/09/BLACK-BG-1.jpg" alt="heading image">
    </div>
